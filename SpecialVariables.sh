...
echo "scriptName is $0"                                           # Prints the script name. 
...
echo "The Arguments in script are $@"                             # Prints the arguments used in the script.
echo "Exit Status of the previous command $?"jg
